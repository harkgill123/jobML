...
from .views import SignUpView, LoginView, LogoutView, UpdatePasswordView, UpdateEmailView, DisplayAllJobsInfo, DisplayResumeInfo, UpdateResumeInfo, UpdateJobPosting
urlpatterns = [
    ...
    path('edit-job-postings/', UpdateJobPosting.as_view(), name = 'edit-job-postings')
]
