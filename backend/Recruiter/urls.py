...
from .views import JobPostingListView, JobPostingCreateView, search_applicants, recommended_jobs, display_user_info, update_feedback, liked_applicants, sendEmailtoApplicant
...
urlpatterns = [
    ...
    path('candidate-recommendations/', recommended_jobs, name='candidate-recommendations'),
