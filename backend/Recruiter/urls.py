...
from .views import JobPostingListView, JobPostingCreateView, search_applicants, sendRecommendationsToFrontEnd, display_user_info, update_feedback, liked_applicants
...
urlpatterns = [
    ...
    path('liked_jobs/', liked_applicants, name='liked_applicants')
]
